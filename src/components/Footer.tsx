    ...
    <footer className="bg-[#060f24] text-white">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10 pt-20 pb-12">
        <div className="grid lg:grid-cols-2 gap-12 mb-12">
              ...
              {Object.entries(footerLinks).map(([col, links]) => (
                <div key={col}>
                  ...
                  <ul className="space-y-3">
                    {links.map((link) => (
                      <li key={link.label}>
                        <a href={link.href} className="text-white/40 hover:text-white text-sm transition-colors duration-200 hover:text-[#fdb822]">
                          {link.label}
                        </a>
                      </li>
                    ))}
          ...
          {/* Right: map */}
          <div>
            <p className="text-white/40 text-xs font-semibold uppercase tracking-widest mb-4">Our Location</p>
            <div className="rounded-2xl overflow-hidden border border-white/10 aspect-square">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d474643.2953639617!2d-96.96453514323109!3d32.886975792651995!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x88b887555b87fc75%3A0x7a241b838ba4dee!2sKC10%20Remodels!5e1!3m2!1sen!2sus!4v1779473883230!5m2!1sen!2sus"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen
